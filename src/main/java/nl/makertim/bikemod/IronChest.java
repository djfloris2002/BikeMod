...
@Mod(modid = ModInfo.ID, name = "Iron Chests", dependencies = "required-after:Forge@[12.17.0.1909,)", acceptedMinecraftVersions = "[1.9.4, 1.11)")
public class IronChest {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		if (properties != null) {
			...
			// String mcversion =
			// properties.getProperty("IronChest.build.mcversion");
